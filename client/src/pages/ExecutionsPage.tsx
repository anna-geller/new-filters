...
const mockExecutions = [
  {
    ...
    namespace: 'company',
    flow: 'data-pipeline',
    labels: ['production', 'team-backend'],
    revision: '1',
  ...
  },
  {
    ...
    labels: ['production', 'team-backend', 'critical'],
    revision: '1',
  ...
  },
  {
    ...
    labels: ['development', 'team-frontend'],
    revision: '4',
  ...
  },
  {
    ...
    flow: 'backup-restore',
    labels: ['production', 'team-analytics', 'maintenance'],
    revision: '6',
  ...
  },
  {
    ...
    labels: ['production', 'team-analytics'],
    revision: '7',
